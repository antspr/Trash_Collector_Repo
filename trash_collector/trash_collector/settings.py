"""
Django settings for trash_collector project.
...
WSGI_APPLICATION = 'trash_collector.wsgi.application'
...
# Tells our application where to go when a user logs in or out
